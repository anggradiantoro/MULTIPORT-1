...
# // Download
cd /usr/bin
wget -O addxray "https://raw.githubusercontent.com/jinGGo007/MULTIPORT/main/XRAY/addxray.sh"
...
# // Menu Xray
wget -O menu-xray "https://raw.githubusercontent.com/jinGGo007/MULTIPORT/main/XRAY/menu-xray.sh"
